...
public class SpeedParticleEffect extends AbstractGameEffect {
    ...
    public SpeedParticleEffect(Color setColor, boolean reverse, float speedMult) {
        if (!reverse) {
            this.x = MathUtils.random(-400.0F, -100.0F) * Settings.scale - 128.0F;
            this.vX = MathUtils.random(1500.0F, 2500.0F) * Settings.scale * speedMult;
        } else {
