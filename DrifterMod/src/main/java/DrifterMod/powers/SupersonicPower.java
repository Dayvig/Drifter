...
public class SupersonicPower extends AbstractPower implements CloneablePowerInterface  {

    public AbstractCreature source;

    public static final String POWER_ID = DrifterMod.makeID("SupersonicPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("supersonic84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("supersonic32.png"));

    public SupersonicPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
