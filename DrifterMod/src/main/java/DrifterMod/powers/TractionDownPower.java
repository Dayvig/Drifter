...
public class TractionDownPower extends AbstractPower implements CloneablePowerInterface  {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("losetraction84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("losetraction32.png"));
