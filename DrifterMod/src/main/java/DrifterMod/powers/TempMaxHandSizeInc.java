...
public class TempMaxHandSizeInc extends AbstractPower implements CloneablePowerInterface, OnRefreshHandPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("overdraw84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("overdraw32.png"));
