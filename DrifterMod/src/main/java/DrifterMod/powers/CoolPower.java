...
public class CoolPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DrifterMod.makeID("CoolPower");
    ...
    public AbstractPower makeCopy() {
        return new CoolPower(owner, source, amount);
    }
}
