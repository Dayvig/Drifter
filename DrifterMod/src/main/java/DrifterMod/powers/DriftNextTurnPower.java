...
public class DriftNextTurnPower extends AbstractPower implements CloneablePowerInterface  {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("driftnextturn84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("driftnextturn32.png"));
