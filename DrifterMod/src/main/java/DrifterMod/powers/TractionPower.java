...
public class TractionPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DrifterMod.makeID("TractionPower");
    ...
    public AbstractPower makeCopy() {
        return new TractionPower(owner, source, amount);
    }
}
