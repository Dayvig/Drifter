...
public class ThermalPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public ThermalPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
