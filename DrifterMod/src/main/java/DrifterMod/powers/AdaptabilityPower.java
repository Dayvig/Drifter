...
public class AdaptabilityPower extends AbstractPower implements CloneablePowerInterface, OnRefreshHandPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("adaptability84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("adaptability32.png"));
