...
public class Ninety extends AbstractDriftCard {

    // TEXT DECLARATION

    public static final String ID = DrifterMod.makeID(Ninety.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("90deg.png");// "public static final String IMG = makeCardPath("${NAME}.png");
