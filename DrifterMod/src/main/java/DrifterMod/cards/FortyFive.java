...
public class FortyFive extends AbstractDynamicCard {
    ...
    public static final String ID = DrifterMod.makeID(FortyFive.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("45deg.png");// "public static final String IMG = makeCardPath("${NAME}.png");
