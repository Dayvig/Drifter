...
public class TractionTires extends AbstractDynamicCard {

    public static final String ID = DrifterMod.makeID(TractionTires.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("TractionTires.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new TractionPower(p, p, magicNumber), magicNumber));
    }
